...
if __name__ == "__main__":
    ...
    Num_train = 3000
    DirName = 'ExportedData/FWD_OgdenGPR_Final/Output_OgdenGPR_Tuned'

    Xscaler_dir = DirName + str(Num_train) + '/GPR_' + str(Num_train) + 'scaler.sav'
    Settings_dir = DirName + str(Num_train) + '/GPR_' + str(Num_train) + 'Settings.sav'
    Model_path = DirName + str(Num_train) + '/GPR_' + str(Num_train) + '.pt'
    ...
    for i,conc in enumerate(conc_list):
        for ii,coagtime in enumerate(coagtime_list):
            for iii, replica in enumerate(replica_list):
                ...
                param_path = './ExportedData/OgdenParams/GPR_C' + str(conc) +'_T'+str(coagtime)+ '_'+ replica + '.csv'
                img_path = './ExportedData/OgdenParams/GPR_C' + str(conc) +'_T'+str(coagtime)+ '_'+ replica + '.png'
